  ...
  return (
    <>
      <section id="menu-why-greenhires" className="relative bg-white">
        <div className="flex container my-20 pl-4 pr-6 flex-col justify-center items-center">
          <div className="mx-4"></div>
          {/*<div className="text-3xl my-6 text-center">Why Green Hires?</div>*/}
          <div className=" h-[450px] w-[80%] bg-gradient-to-b from-slate-300 to-teal-200 rounded-[30px]">
            <div className="my-16 relative">
              <button
                onMouseOver={() => setFeature(0)}
                className={`flex w-[98%] absolute rounded-[20px] p-5 items-center shadow-xl shadow-indigo-200/50 
              ...
              >
                <Image
                  ...
                  height={60}
                  alt="tab-icon"
                  src="/images/menu/tab_icon_1.png.png"
                />
                <div className="ml-5">
        ...
        <div className="absolute -top-1/2 pointer-events-none z-[100] right-0 opacity-30 lg:opacity-100">
          <svg
            width="373"
            height="610"
            viewBox="0 0 373 610"
