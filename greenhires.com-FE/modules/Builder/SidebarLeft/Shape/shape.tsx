...
export const shapes: Shape[] = [
  {
    ...
    icon: (
      <IconBox>
        <RectangleIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <CircleIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <TriangleIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <IconBox>
        <RhombusIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <ArrowRightIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <ArrowLeftIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <ArrowTopIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <IconBox>
        <ChevronIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox>
        <CrossIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <IconBox>
        <TrapezoidIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <IconBox>
        <PentagonIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
    ...
    icon: (
      <IconBox extraCss={{ transform: "rotate(90deg)" }}>
        <HexagonIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <IconBox>
        <OctagonIcon height={"100%"} width={"100%"} className="text-[#D9D9D9]" />
      </IconBox>
    ),
  },
];
